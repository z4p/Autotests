...
element = driver.find_elements_by_class_name('item')[3] #кнопка Колледжи и лицеи
element.click()


print ('Вы находитесь в разделе "Колледжи и лицеи"')
print ('Проверить отображение следующей информации:')
print('                             * текст "Средние специальные и профессионально-технические учебные заведения"')
print('                             * текст "Вы ещё не добавляли учреждения и программы этой категории в избранное"')
print('                             * после добавления колледжей, будут отображаться плитки с избранными колледжами')
